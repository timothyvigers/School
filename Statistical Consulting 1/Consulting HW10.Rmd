...
$$
n = \frac{\sigma^2(Z_{0.1}+Z_{0.975})^2}{\text{(detectable difference)^2}}=\frac{19.44364(-1.28+1.96)}{(0.6)^2}=\frac{13.22168}{0.36} = 36.72688
$$
So for 90% power to detect a TAZ of 0.6 mg/day, Jamie will need 37 participants (assuming a fairly high SD of 4.41 mg/day).
