...
$$
\text{odds}=e^{0.0300}=1.030\\
\text{CI lower} = e^{0.0300-1.96(0.00315)} = e^{0.023826}=1.024\\
\text{CI upper} = e^{0.0300+1.96(0.00315)} = e^{0.036174}=1.037\\
$$

There is a significant association between classification score and misconduct violations in the first year of incarceration (p <0.0001). On average, the odds of a violation increase 1.03 times (95% CI: 1.024,1.037) for each 1 unit increase in classification score.
