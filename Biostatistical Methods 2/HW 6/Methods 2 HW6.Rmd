...
You can't compare investigator 3's models using the LRT because they have different covariance structures. 

# Ask about this

##4. Best model

I think the random intercept model run by investigator 3 is the best, because it answers the scientific question while accounting for within subject correlation. Investigator 1's model answers the correct question, but does not consider the fact that measurements within each subject will be correlated. Finally, investigator 2's model doesn't answer the correct question. 
...
\end{pmatrix}\\
=\begin{pmatrix}
\sigma^2_0+\sigma^2_{0s} & \sigma^2_0+2\sigma^2_{0s} \\
\sigma^2_{0s}+\sigma^2_s & \sigma^2_{0s}+2\sigma^2_s
\end{pmatrix}+\begin{pmatrix}
\sigma^2_{\epsilon} & 0 \\
0 & \sigma^2_{\epsilon}
\end{pmatrix}=\begin{pmatrix}
\sigma^2_0+\sigma^2_{0s}+\sigma^2_{\epsilon} & \sigma^2_0+2\sigma^2_{0s} \\
\sigma^2_{0s}+\sigma^2_s & \sigma^2_{0s}+2\sigma^2_s+\sigma^2_{\epsilon}
\end{pmatrix}\\
(\sigma^2_0+\sigma^2_{0s})(\sigma^2_{0s}+2\sigma^2_s)-(\sigma^2_0+2\sigma^2_{0s})(\sigma^2_{0s}+\sigma^2_s) = \sigma^2_0\sigma^2_s - (\sigma^2_{0s})^2\\
$$
