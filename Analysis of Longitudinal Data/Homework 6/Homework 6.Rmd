...
The residual estimate is equivalent to the square of the scale parameter, so $\sqrt{0.6619} = 0.814$. This is a little bit lower than the scale parameter from the GEE (0.857), but I'd say they're pretty close.  
