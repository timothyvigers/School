...
format_nlme_out(mod_ar1,varnames = "% of FG Assisted")
```

An increase of 10 points in percentage of FGs assisted can lead to an approximately 6 point increase in winning percentage on the season. So, about 5 games per season. 
