...
1. Muggeo, V.M.R. (2003) Estimating regression models with unknown break-points.
    Statistics in Medicine 22, 3055–3071.

2. Vito M. R. Muggeo (2008). segmented: an R Package to Fit Regression Models with
    Broken-Line Relationships. R News, 8/1, 20-25. URL
    https://cran.r-project.org/doc/Rnews/.

3. Tingley D, Yamamoto T, Hirose K, Keele L, Imai K. mediation: R package for causal
