...
As one might expect, the percentage of baskets assisted has a significant positive association with winning percentage. A 10 point increase in AST% can on average lead to an additional 1 - 3 games won per season. This may not sound like a great return but for some teams, particularly in the competitive Western conference, this could be the difference between making the playoffs or not. Playoff games are an enormous source of revenue, with some teams earning as much as $2 million per game [5]. So those 1-3 extra wins could be worth millions of dollars, and would only require that teams make sure that an additional 1 out of 10 baskets made is directly preceded by a pass. 
