...
The model selection process for the hypothesis that increasing assists results in more wins followed a similar process to the selection processing for the passing question. I compared models with random intercept for team and random intercept for team and random slope for season, both with and without an AR(1) structure for repeated measures. However, in these models the outcome is regular season win percentage and the fixed effects are average team age; average team height; average team weight; and assists, steals, blocks, and turnovers per game. Again, the model with random intercept for team and AR(1) structure for repeated measures was the best by AIC.



```{r mediation,echo=FALSE,include=FALSE,cache=TRUE}
# nlme
