...
There were lockout seasons in 1998 and 2011, so totals are much lower for those years for all teams. Probably best to use percentage of baskets assisted. Unfortunately, passing data only goes back 6 years. Assist data goes back to the 40s, but is significantly more subjective.
...
```{r passing,echo=FALSE,warning=FALSE,message=FALSE}
# Season to starting year
