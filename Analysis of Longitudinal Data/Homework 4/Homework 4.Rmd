...
The scale parameter above comes from SAS, but to determine it in R you would just divide the SEs from the quasilikelihood model by the SEs from the simple Poisson model. The point here is that the SEs have a linear relationship based on the scale parameter $\phi$.
