...
mle <- optim(par=init, tobit_fun, y=pcbs$log_Yi, X=X, ll=-6.9,hessian = T)
mle$par
I <- mle$hessian
...
# Although we're assuming that logvl is normally distributed at each week, this doesn't appear to be the case.
```
