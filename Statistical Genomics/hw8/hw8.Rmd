...
where $n_w$ represents the number of nucleotides in window $w$ and $x_{IP_{i,w}}$ and $x_{Control_{i,w}}$ represent the number of sequences mapped at position $i$ in input and control samples, respectively. Peaks are selected if $C_{1,w}\geq T_1\times G_{IP}; C_{2,w}\leq T_2\times G_{Control}; C_{3,w} \geq T3\text{ and }C_{4,w} \geq Quantile(C_4, T_4)$.
