...
![A plot of the densities for PM for each of the 27
spike-in datasets, with distribution after quantile normalization
superimposed. (Bolstad et al., 2003)]("./pm_density.png"){width=90%}
...
![$log_2$ variance ratio versus average $log_2$ mean for liver
dilution data at concentration 10. (Bolstad et al., 2003)]("./variance_mean.png"){width=90%}

## Results

![$log_2$ variance ratio versus average $log_2$ mean using the spike-in
data. Comparing the baseline methods with the quantile method. (Bolstad et al., 2003)]("./variance_mean_spike.png"){width=80%}
...
1. What does this last figure show?
