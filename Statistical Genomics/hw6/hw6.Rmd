...
The genes that are significant when using the common dispersion tend to have low counts across most samples with a few samples with high expression levels. One the other hand, the top genes based on tagwise dispersion tend to have counts more evenly spread across the samples.
