...
Each 450K array includes internal control probes to help with quality control of various pre-treatment steps. Bisulfite conversion probes are included to help assess the efficiency of bisulfite conversion. Negative controls are included to help with background correction, by targeting bisulfite-converted sequences that don't contain CpGs. 
