...
fit_tprs_x1_x2_f1 <- gam(y_x1_x2_f1 ~ te(x1, x2, k=30, bs="tp"), method="REML", data=df_fit)
fit_tprs_x1_x2_f2 <- gam(y_x1_x2_f2 ~ te(x1, x2, k=30, bs="tp"), method="REML", data=df_fit)
